...
func (a *ProcuradorGeral) AgenteCriarAcaoTexto(w http.ResponseWriter, r *http.Request) {
	if err := r.ParseForm(); err != nil {
		fmt.Println("Erro na leitura do formulario de acao texto")
		return
	}
	return
}
...
func (a *ProcuradorGeral) AgenteAPI(w http.ResponseWriter, r *http.Request) {
	if err := r.ParseForm(); err != nil {
		return
	}
